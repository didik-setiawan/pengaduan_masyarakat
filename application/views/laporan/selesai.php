...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
			<h4>Laporan Pengaduan Sudah Selesai</h4>
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="card shadow">
							<div class="card-body">
								<form action="<?= base_url('laporan/status_selesai'); ?>" method="get">
								...
								<small>Jumlah semua data : <?= $this->db->get_where('tb_pengaduan',['status' => 1])->num_rows(); ?></small>
